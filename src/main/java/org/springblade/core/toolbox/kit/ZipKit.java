...
import org.springblade.core.toolbox.support.FastByteArrayOutputStream;
 ...
 */
public class ZipKit {
	private final static Logger log = LogManager.getLogger(ZipKit.class);
	 ...
	 */
	private static void validateFiles(File zipFile, File... srcFiles) throws ToolBoxException {
		for (File srcFile : srcFiles) {
