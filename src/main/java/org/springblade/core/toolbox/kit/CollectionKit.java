...
import org.springblade.core.toolbox.support.BoundedPriorityQueue;
...
public class CollectionKit {
	 ...
	 * @return 包装类型数组或对象数组
	 * @throws ToolBoxException 对象为非数组
	 */
	public static Object[] wrap(Object obj) {
		...
		throw new ToolBoxException(StrKit.format("[{}] is not Array!", obj.getClass()));
	}
